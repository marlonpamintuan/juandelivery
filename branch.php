...
<head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
      <title>Juan Delivery - Branch</title>
       ...
       <div class="collapse navbar-collapse" id="#navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-nav">
                ...
                <li><a href="contact.php">Contact</a></li>
                 <li class="dropdown dropdown-toggle active"><a href="#" data-toggle="dropdown">Branch <span><i class="fa fa-angle-down"></i></span></a>
...
<section class="about-text">
    <div class="container">
      <div class="row">
                <div class="col-sm-8">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3913.8558015808107!2d125.00272001435486!3d11.198302992036144!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x330877a8645080eb%3A0x48d8bc28ce111e57!2sTACLOBAN+CITY+HOSPITAL!5e0!3m2!1sen!2sph!4v1497783687765" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
                 <div class="col-sm-4">
           <iframe src="https://www.google.com/maps/embed?pb=!1m0!4v1497783727576!6m8!1m7!1sDaeDVn08XHEIveU4hsIVxw!2m2!1d11.19862160320525!2d125.005148639856!3f220!4f0!5f0.7820865974627469" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
                </div>
                  <br>
     <div class="row">
     ...
     <h2><strong>TACLOBAN CITY</strong></h2>
     <h3>UNIT 14 BARANGAY 80 MARASBARAS TACLOBAN CITY</h3>
     <h3>0909-012-0055</h3>
     </div>
  
        <div class="col-md-4">
    <img src="asset/img/tacloban.jpg" class="img img-rounded" style="width: 100%;"/>
     </div>
     </div> 
    </div>
    ...
    <div class="copyright-section">
        <div class="container clearfix">
            ...
            <ul class="list-inline pull-right">
                ...
                <li><a href="services.php">Rates and Services</a></li>
                <li><a href="contact.php">Contact</a></li>
                <li class="active"><a href="branch.php">Branch</a></li>
                <li><a href="partner.php">Partner ni Juan</a></li>
                           <?php
if(isset($_SESSION['session_id']) || !empty($_SESSION['session_id'])) 
{
