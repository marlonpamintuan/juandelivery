...
<div class="wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <span class="glyphicon glyphicon-plus-sign "></span> <strong>ADD NEW USER</strong>
        </button>
          </h3></div><br>
            <!-- /.box-header -->
            <div class="box-body">
 ...
 <!-- add modal -->
  ...
  <input type="text" class="form-control" placeholder="First Name" id="USER_FIRSTNAMEC" name="USER_FIRSTNAMEC">
  </div>
  </div>
  <div class="col-md-6"> 
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-user"></i></span>
  <input type="text" class="form-control" placeholder="Last Name" id="USER_LASTNAMEC" name="USER_LASTNAMEC">
  </div>
  </div>
</div>
<br>
<div class="row">
  ...
  <input type="number" class="form-control" placeholder="Contact Number" id="USER_CONTACTNUMBERC" name="USER_CONTACTNUMBERC">
  </div>
  </div>
  <div class="col-md-6"> 
  <label for="editName" class="control-label">Email Address</label>
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-user"></i></span>
  <input type="email" class="form-control" placeholder="Email Address" id="USER_EMAILC" name="USER_EMAILC">
  </div>
  </div>
</div>
<br>
<div class="row">
  <div class="col-md-6"> 
  <label for="editName" class="control-label">Username</label>
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-lock"></i></span>
  <input type="text" class="form-control" placeholder="Username" id="SECURITY_USERNAMEC" name="SECURITY_USERNAMEC">
  </div>
  </div>
  <div class="col-md-6"> 
  <label for="editName" class="control-label">Password</label>
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-lock"></i></span>
  <input type="password" class="form-control" placeholder="Password" id="SECURITY_PASSWORDC" name="SECURITY_PASSWORDC">
  </div>
  </div>
</div>
<br>
<div class="row">
<div class="col-md-12">
  <label for="editName" class="control-label">User Access</label>
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-lock"></i></span>
<select class="form-control" name="SECURITY_ACCESS" id="SECURITY_ACCESS" title="Tell the system what is the access of this user">
  <option label="-- Choose Type --"></option>
  <option value="admin">Admin</option>
  <option value="customer">Customer</optionn>
    <option value="tacloban">Admin Tacloban</optionn>
</select>
  </div>
</div>
</div>
...
<div class="row">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-phone"></i></span>
  <input type="number" class="form-control" placeholder="Contact Number" id="USER_CONTACTNUMBER" name="USER_CONTACTNUMBER">
  </div>
  </div>
  <div class="col-md-6"> 
  <label for="editName" class="control-label">Email Address</label>
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-user"></i></span>
  <input type="email" class="form-control" placeholder="Email Address" id="USER_EMAIL" name="USER_EMAIL">
  </div>
  </div>
</div>
<br>
<div class="row">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-lock"></i></span>
  <input type="text" class="form-control" placeholder="Username" id="SECURITY_USERNAME" name="SECURITY_USERNAME">
  </div>
  </div>
  <div class="col-md-6"> 
  <label for="editName" class="control-label">Password</label>
  <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-lock"></i></span>
  <input type="password" class="form-control" placeholder="Password" id="SECURITY_PASSWORD" name="SECURITY_PASSWORD">
  </div>
  </div>
</div>
