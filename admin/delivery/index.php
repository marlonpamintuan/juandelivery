...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
   For Delivery
        <small>For delivery items to customer</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">for-delivery</a></li>
        <li class="active">for-delivery list</li>
      </ol>
    </section>
 ...
 <th class="bg-primary"></th>
               ...
               <th class="bg-primary">CONSIGNEE</th>          
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><span class="glyphicon glyphicon-trash"></span> Delete Transaction</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="doneModal">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"><span class="fa fa-check-square-o"></span> Set As Done</h4>
        </div>
        <div class="modal-body">
          <p>Do you really want to move this to done transaction?</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
 ...
 <div class="row">
  ...
  <div class="col-sm-4"> 
      <label for="editName" class="control-label">Item Insurance</label>
           <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-question"></i></span>
  <input type="text" class="form-control" id="BOOKING_INSURANCE" name="BOOKING_INSURANCE" placeholder="Yes/No">
  </div>
        <!-- here the text will apper  -->
  </div>
  <div class="col-sm-4"> 
