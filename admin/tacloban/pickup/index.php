...
<div class="col-sm-4">
  ...
  <?php
$employee_query = mysqli_query($link,"select * from employee where EMPLOYEE_BRANCH = 'Tacloban'");
...
?><option value="<?php echo $FULLNAME;?>"><?php echo $FULLNAME;?></option><?php
  ...
  ?>
          ...
          <div class="col-sm-4">
  <label for="editAddress" class="control-label">COD Payment ( IF COD )</label>
         <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-money"></i></span>
