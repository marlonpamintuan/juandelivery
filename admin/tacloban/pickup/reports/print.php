...
// $query ="select * from pickup inner join consignee on pickup.REQUEST_ID = consignee.REQUEST_ID where PICKUP_DATECREATED='$DATECREATED' and CONSIGNEE_DATECREATED='$DATECREATED' and STATUS != 'invalid'";
 $query ="select * from booking where BOOKING_STATUS = 'for-pickup' and BOOKING_BRANCH='Tacloban'";
...
<div class="container s">
		...
		<h5>Date Booked : <?php echo date('m-d-Y',strtotime($BOOKING_DATE));?></h5>
		...
		<thead>
		<tr>
		<td class="text-center" style="padding-left:5px;padding:right:5px;"><h6 style="">SHIPPER</h6></td>
		<td class="text-center" style="padding-left:5px;padding:right:5px;"><h6>CONTACT NO.</h6></td>
		<td class="text-center" style="padding-left:5px;padding:right:5px;"><h6>ADDRESS</h6></td>
			<td class="text-center" style="padding-left:5px;padding:right:5px;"><h6>NEAR LANDMARK</h6></td>
				
		</tr>
		</thead>
		<tbody>
		<tr>
		<td class="text-center" style="padding-left:5px;"><h6><?php echo $BOOKING_PSENDER;?></h6></td>
		<td class="text-center" style="padding-left:5px;"><h6><?php echo $BOOKING_PCONTACTNUMBER;?></h6></td>
<td class="text-center" style="padding-left:5px;"><h6><?php echo $BOOKING_PCITY.' '.$BOOKING_PADDRESS;?></h6></td>

<td class="text-center" style="padding-left:5px;"><h6><?php echo $BOOKING_PLANDMARK;?></h6></td>
		</tr>
		</tbody>
		</table>
...
<td class="text-center" style="padding-left:5px;"><h6><?php echo $BOOKING_DESCRIPTION;?></h6></td>
		</tr>
		</tbody>
		</table>
