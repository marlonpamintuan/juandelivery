...
if($_POST) {	
	...
	$sql = "INSERT INTO employee(EMPLOYEE_FIRSTNAME,EMPLOYEE_LASTNAME,EMPLOYEE_CONTACTNUMBER,EMPLOYEE_POSITION,EMPLOYEE_DATECREATED,EMPLOYEE_BRANCH) VALUES ('$EMPLOYEE_FIRSTNAMEC','$EMPLOYEE_LASTNAMEC','$EMPLOYEE_CONTACTNUMBERC','$EMPLOYEE_POSITIONC','$EMPLOYEE_DATECREATED','Tacloban')";
