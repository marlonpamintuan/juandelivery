...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <!-- Left col -->
        <div id="TaclobanModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-pie-chart"></i> Number of Booked Transaction Per Day Tacloban Branch</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a class="btn btn-default btn-sm pull-right" href="" data-target="#TaclobanModal" data-toggle="modal">     
                <i class="fa fa-pie-chart text-primary"></i> &nbsp;See Tacloban</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <!-- /.Left col -->
          <section class="col-lg-3 connectedSortable">
            ...
            <div class="info-box-content">
              <span class="info-box-text">PICKUP REQUEST</span>
              <span class="info-box-number"><span id="tacloban_request">...</span></span>
                 <div class="progress">
            ...
            <div class="info-box-content">
              <span class="info-box-text">FOR PICKUP</span>
              <span class="info-box-number"><span id="tacloban_pickup">...</span></span>
                 <div class="progress">
                     <div class="progress-bar" style="width: 100%"></div>
                </div>
              <span class="progress-description">
          ...
          <div class="info-box bg-green">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><span id="tacloban_delivery">...</span></span>
                 <div class="progress">
                     <div class="progress-bar" style="width: 100%"></div>
                </div>
              <span class="progress-description">
          ...
          <div class="info-box bg-blue">
            ...
            <div class="info-box-content">
              <span class="info-box-text">DONE TRANSACTIONS</span>
              <span class="info-box-number"><span id="tacloban_transaction">...</span></span>
                 <div class="progress">
                     <div class="progress-bar" style="width: 100%"></div>
                </div>
              <span class="progress-description">
                   Cancelled Items<b id="tacloban_cancelled" class="pull-right">...</b>
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
          ...
          <div class="box box-primary" style="height:100%; overflow: auto;">
            <div class="box-header">
              ...
              <div class="btn-group pull-right">
                  <a class="btn btn-social btn-default" href="php/backup.php">
                <i class="fa fa-floppy-o text-success"></i> <strong>BACKUP YOUR DATA</strong>
              </a>
