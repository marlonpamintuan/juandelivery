 ...
 <header class="main-header">
    ...
    <li><a onclick="return false" href=""><i class="fa fa-clock-o "></i><span>Time: </span> <span id="websitetime"></span></a></li>
        ...
        <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="../../reports/pickup_reports"><i class="fa fa-circle-o"></i> Pickup Report</a></li>
          
            <li><a href="../../reports/delivery_reports"><i class="fa fa-circle-o"></i> Delivery Report</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
   Delivery Reports
        <small>For delivery reports</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <h3 class="box-title">
      <a class="btn btn-primary" href="print.php"><strong><span class="fa fa-print"></span>&nbsp;PRINT ALL</strong></a>
            <a class="btn btn-info" href="" data-toggle="modal" data-target="#print"><strong><span class="fa fa-print"></span>&nbsp;PRINT BY SHIPPER AND DATE</strong></a>
   <a class="btn btn-success" href="excel.php"><strong><span class="fa fa-file-excel-o"></span>&nbsp;Export to Excel File</strong></a>

          </h3></div><br>
            <!-- /.box-header -->
            <div class="box-body">
          <form action="print_per.php" method="POST">
             <div class="row">
            <div class="col-md-12">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">PRINT BY SENDER AND DATE</h4>
      </div>
      <div class="modal-body">
        <form action="printbyname.php" method="POST">
             <div class="row">
            <div class="col-md-12">
            <div class="form-group">
                <label>Enter the date you want to print (<font color="green">Date based on the date customer requested a pickup</font>)</label>
                ...
                <div class="input-group date">
                  ...
                  <input type="text" name="BOOKING_DATE"  class="form-control pull-right" id="datepicker2" required/>
                </div>
                <!-- /.input group -->
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <select class="form-control select2" name="PSENDER" style="width: 100%;" required="">
                  <option label="Choose Sender"></option>
                  <?php $sender = mysqli_query($link,"select BOOKING_PSENDER from booking where BOOKING_STATUS !='deleted' GROUP BY BOOKING_PSENDER");
                  while($row = mysqli_fetch_array($sender)){
                    $SENDER = $row['BOOKING_PSENDER'];
                    ?><option value="<?php echo $SENDER;?>"><?php echo $SENDER;?></option><?php
                  }
                  ?>
                </select>
                </div>
...
<div class="col-sm-12">
  ...
  <input type="text" class="form-control" id="BOOKING_PAYMENT" name="BOOKING_PAYMENT" placeholder="Mode of Payment" disabled="">
  </div>
...
<div class="col-sm-4">
  <label for="editAddress" class="control-label">Pickup By</label>
         <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-user"></i></span>
  <input type="text" class="form-control" placeholder="Pickup By" id="BOOKING_PBY" name="BOOKING_PBY" disabled="">
  </div>
          </div>
          <div class="col-sm-4">
  <label for="editAddress" class="control-label">Amount Collected</label>
         <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-money"></i></span>
  <input type="number" class="form-control" placeholder="Amount Collected" id="BOOKING_AMOUNTCOLLECTED" name="BOOKING_AMOUNTCOLLECTED" disabled="">
  </div>
          </div>
          <div class="col-sm-4">
  <label for="editAddress" class="control-label">Delivery Date</label>
         <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
  <input type="date" class="form-control" placeholder="" id="BOOKING_DELIVERYDATE" name="BOOKING_DELIVERYDATE" disabled="">
  </div>
          </div>
          </div>
          <br>
