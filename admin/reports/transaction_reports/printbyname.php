...
$PSENDER = $_POST['PSENDER'];
 $query ="select * from booking where BOOKING_STATUS='for-delivery' and BOOKING_PSENDER='$PSENDER' and BOOKING_DATE='$BOOKING_DATE' and BOOKING_BRANCH='Manila'";
$sum = mysqli_query($link,"select SUM(BOOKING_PRICE) as total from booking where BOOKING_DATE='$BOOKING_DATE' AND BOOKING_PSENDER='$PSENDER' AND BOOKING_STATUS = 'for-delivery'");
$result = mysqli_query($link,$query);
$result_total = mysqli_fetch_array($sum);
$total_price = $result_total['total'];
...
<div class="container s">
			...
			<h5><strong>JUAN DELIVERY</strong></h5>
		<h5>Date : <?php echo $BOOKING_DATE;?></h5>
		<div class="row">
		<div class="col-xs-6">
...
<td style="padding-left:5px;"><h6><?php echo $BOOKING_REMARKS;?></h6></td>
		</tr>
		</tbody>
		</table>
...
<div class="container s">
<?php  
echo '<strong class="pull-right" style="border:2px solid black; padding:10px;">TOTAL PRICE: Php '. $total_price.'</strong>';?>
</div>
<?php
