...
<head>
  ...
  <title>All Cancelled Items</title>
...
<header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
   All Cancelled Reports
        <small>All cancelled items including tacloban branch</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">reports</a></li>
        <li class="active">cancelled report</li>
      </ol>
    </section>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form action="excel_per.php" method="POST">
             <div class="row">
            <div class="col-md-12">
    ...
    <a class="btn btn-success btn-flat" href="excel.php"><strong><span class="fa fa-file-excel-o"></span>&nbsp;EXPORT TO EXCEL FILE</strong></a>
...
<div class="col-sm-12">
  ...
  <input type="text" class="form-control" id="BOOKING_DESCRIPTION" name="BOOKING_DESCRIPTION" placeholder="Item Description" disabled="">
  </div>
      </div>
    </div>
    <br>
 ...
 <div class="row">
  <div class="col-sm-4"> 
      <label for="editName" class="control-label">Remarks</label>
          <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-info"></i></span>
  <input type="text" class="form-control" id="BOOKING_REMARKS" name="BOOKING_REMARKS" placeholder="Remarks" disabled="">
  </div>
      </div>
  <div class="col-sm-4"> 
...
<div class="col-sm-4">
  ...
  <label for="editAddress" class="control-label">COD Payment</label>
         <div class="input-group">
  <span class="input-group-addon"><i class="fa fa-money"></i></span>
  <input type="number" class="form-control" placeholder="COD Payment" id="BOOKING_CODPAYMENT" name="BOOKING_CODPAYMENT" disabled="">
  </div>
          </div>
          <div class="col-sm-4">
