...
$query = mysqli_query($link,"select * from booking where BOOKING_STATUS='for-pickup' and BOOKING_BRANCH='Manila'");
...
?>
<div class="row">
<div class="col-xs-offset-1 col-xs-5 text-center xs" style="margin-top:137px; font-size:12px; color:red!important;">
<?php echo strtoupper($BOOKING_PSENDER);?><br><br>
<font style="font-size:10px; color:red!important;"><?php echo strtolower($BOOKING_PADDRESS);?></font><br><br>
<?php echo strtoupper($BOOKING_PCONTACTNUMBER);?><br><br>
<?php echo strtoupper($BOOKING_DCONSIGNEE);?><br><br>
<font style="font-size:10px; color:red!important;"><?php echo strtolower($BOOKING_DADDRESS);?></font><br><br>
<?php echo strtoupper($BOOKING_DCONTACTNUMBER);?>
</div>
</div>
<div class="row">
<div class="col-xs-3 text-center" style="margin-top:108px;font-size:12px; color:red!important;">
