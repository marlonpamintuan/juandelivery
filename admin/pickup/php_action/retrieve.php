...
$sql = "SELECT * FROM booking where BOOKING_STATUS='for-pickup' and BOOKING_BRANCH='Manila'";
	 ...
	 <span class="caret"></span>
	  ...
	  <ul class="dropdown-menu">
	      	    <li><a type="button" href="" data-toggle="modal" data-target="#editMemberModal" onclick="editMember('.$row['BOOKING_ID'].')"> <span class="glyphicon glyphicon-edit text-info"></span> View / Edit</a></li>
	      	      <li><a type="button" href="waybill.php?id='.$row['BOOKING_ID'].'"> <span class="fa fa-file text-success"></span>Print Way Bill</a></li>
