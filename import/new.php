...
$sql = "SELECT * FROM `pickup` INNER JOIN consignee ON pickup.REQUEST_ID=consignee.REQUEST_ID where `pickup`.`STATUS` = 'invalid' and pickup.DELIVER_STATUS = '' and USER_ACCESS ='' and PICKUP_DATECREATED='07-17-2017'"; 
