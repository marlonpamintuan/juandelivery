<?php
	...
	//login function
		...
		$query = mysqli_query($link,"insert into user(USER_FIRSTNAME,USER_LASTNAME,USER_CONTACTNUMBER,USER_EMAIL,USER_DATECREATED,USER_IMAGE) 
		VALUES ('$USER_FIRSTNAME','$USER_LASTNAME','$USER_CONTACTNUMBER','$USER_EMAIL','$USER_DATECREATED','avatar5.png')");
