...
<head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
      <title>Juan Delivery - Login</title>
    <!-- web-fonts -->
...
<section class="about-text">
    ...
    <span class="fa fa-lock text-primary" style="font-size: 50px;"></span>
    </div>
    </div>
<div class="row">
<div class="col-md-12">
<input type="text" name="SECURITY_USERNAME" value="<?php echo $temp;?>" id="SECURITY_USERNAME" placeholder="Username" title="Username" class="form-control" style="font-size:15px;color:#2d2d2d; border:1px solid #c3c3c3; border-radius: 5px; height:45px;" required="" />
</div>
</div><br>
<div class="row">
<div class="col-md-12">
<input type="password" title="Password" name="SECURITY_PASSWORD" id="SECURITY_PASSWORD" placeholder="Password"  class="form-control" style="font-size:15px;color:#2d2d2d;border:1px solid #c3c3c3; border-radius: 5px; height:45px;" required="" />
</div>
</div>
<br>
<div class="row">
<div class="col-xs-6">
<a href="register.php" class="btn-success btn btn-block" title="Create Juan Delivery Account"><strong><span class="fa fa-edit"></span>&nbsp;SIGN UP</strong></a>
</div>
<div class="col-xs-6">
<button type="submit" class="btn-info btn btn-block" title="Sign In to Book Online"><strong><span class="fa fa-lock"></span>&nbsp;SIGN IN</strong></button>
</div>
</div>
<div class="row">
<div class="col-xs-12 text-right">
<a href="forgot.php" style="font-size:12px;" title="Click me for password recovery"><strong><u>FORGOT PASSWORD</u></strong></a>
</div>
</div>
    </div>
    </div>
